...
namespace NetworkUI
{
    ...
    public class NodeItem : ListBoxItem
    {
        ...
        internal static readonly DependencyProperty NewLinkConnectorProperty =
            DependencyProperty.Register("NewLinkConnector", typeof(ConnectorItem), typeof(NodeItem));
        ...
        /// <summary>
        /// Connector item for dragging a new link from the node. Not part of the actual node connectors.
        /// </summary>
        internal ConnectorItem NewLinkConnector
        {
            get
            {
                return (ConnectorItem)GetValue(NewLinkConnectorProperty);
            }
            private set
            {
                SetValue(NewLinkConnectorProperty, value);
            }
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            //Unpack The out link connector
            NewLinkConnector = (ConnectorItem)this.Template.FindName("PART_NewLinkConnector", this);
            if (NewLinkConnector == null)
                throw new ApplicationException("Failed to find 'PART_NewLinkConnector' in the visual tree for 'NodeItem'.");
        }
