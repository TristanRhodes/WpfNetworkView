...
namespace NetworkUI
{
    ...
    public partial class NetworkView : Control
    {
        ...
        public static readonly DependencyProperty EnableNodeConnectionDraggingProperty =
            DependencyProperty.Register("EnableNodeConnectionDragging", typeof(bool), typeof(NetworkView),
        ...
        public static readonly RoutedEvent NodeConnectionCreatedEvent =
            EventManager.RegisterRoutedEvent("NodeConnectionCreated", RoutingStrategy.Bubble, typeof(NodeConnectionCreatedEventHandler), typeof(NetworkView));

        public static readonly RoutedEvent NodeConnectionDraggingEvent =
            EventManager.RegisterRoutedEvent("NodeConnectionDragging", RoutingStrategy.Bubble, typeof(NodeConnectionDraggingEventHandler), typeof(NetworkView));
        ...
        public static readonly RoutedCommand BeginNodeConnectionDragCommand = null;
        ...
        /// </summary>
        private NodeItemsControl _nodeItemsControl = null;

        /// <summary>
        /// Cached reference to the ItemsControl for connections in the visual-tree.
        /// </summary>
        private ItemsControl _connectionItemsControl = null;

        /// <summary>
        /// Cached list of currently selected nodes.
        /// </summary>
        private List<object> _initialSelectedNodes = null;
        ...
        public NetworkView()
        {
            ...
            //Add handlers for connector events
        ...
        /// <summary>
        /// Event raised when the network confirms a connection is to be created.
        /// </summary>
        public event NodeConnectionCreatedEventHandler NodeConnectionCreated
        {
            add { AddHandler(NodeConnectionCreatedEvent, value); }
            remove { RemoveHandler(NodeConnectionCreatedEvent, value); }
        }

        /// <summary>
        /// Event raised when the network confirms a connection is to be created.
        /// </summary>
        public event NodeConnectionDraggingEventHandler NodeConnectionDragging
        {
            add { AddHandler(NodeConnectionDraggingEvent, value); }
            remove { RemoveHandler(NodeConnectionDraggingEvent, value); }
        }
        ...
        /// <summary>
        /// Set to 'true' to enable the creation of new connections by connecting directly between nodes.
        /// </summary>
        public bool EnableNodeConnectionDragging
        {
            get
            {
                return (bool)GetValue(EnableNodeConnectionDraggingProperty);
            }
            set
            {
                SetValue(EnableNodeConnectionDraggingProperty, value);
            }
        }
        ...
        static NetworkView()
        {
            ...
            BeginNodeConnectionDragCommand = new RoutedCommand("BeginNodeConnectionDrag", typeof(NetworkView));
            ...
            binding = new CommandBinding();
            binding.Command = BeginNodeConnectionDragCommand;
            binding.Executed += new ExecutedRoutedEventHandler(BeginNodeConnectionDrag_Executed);
            CommandManager.RegisterClassCommandBinding(typeof(NetworkView), binding);
        }
        ...
        /// <summary>
        /// Put the canvas into node to node connection dragging mode.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e">Event args - Expects a NodeItem.</param>
        private static void BeginNodeConnectionDrag_Executed(object sender, ExecutedRoutedEventArgs e)
        {
            var c = (NetworkView)sender;
            c.BeginNodeConnectionDrag(e.Parameter);
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            this._nodeItemsControl = (NodeItemsControl)this.Template.FindName("PART_NodeItemsControl", this);
            if (this._nodeItemsControl == null)
            {
            ...
            //
            if (this._initialSelectedNodes != null && this._initialSelectedNodes.Count > 0)
            {
                foreach (var node in this._initialSelectedNodes)
                {
                    this._nodeItemsControl.SelectedItems.Add(node);
                }
            }

            this._initialSelectedNodes = null; // Don't need this any more.

            this._nodeItemsControl.SelectionChanged += new SelectionChangedEventHandler(nodeItemsControl_SelectionChanged);

            this._connectionItemsControl = (ItemsControl)this.Template.FindName("PART_ConnectionItemsControl", this);
            if (this._connectionItemsControl == null)
            {
            ...
            this._dragConnectionLine = (Line)this.Template.FindName("PART_DragConnectionLine", this);
            if (this._dragConnectionLine == null)
                throw new ApplicationException("Failed to find 'PART_DragConnectionLine' in the visual tree for 'NetworkView'.");
        }
        ...
        internal int FindMaxZIndex()
        {
            ...
            {
                NodeItem nodeItem = (NodeItem)this._nodeItemsControl.ItemContainerGenerator.ContainerFromIndex(nodeIndex);
