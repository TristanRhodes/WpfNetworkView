...
namespace NetworkUI
{
    ...
    public partial class NetworkView
    {
        ...
        /// <summary>
        /// Set to true when the user is dragging a node connection.
        /// </summary>
        private bool isDraggingNodeConnection = false;
        ...
        protected override void OnMouseUp(MouseButtonEventArgs e)
        {
            ...
            {
                DropNodeConnection(e.GetPosition(this));
            }
        ...
        protected override void OnMouseMove(MouseEventArgs e)
        {
            ...
            else if (isDraggingNodeConnection)
            {
                var curMouseDownPoint = e.GetPosition(this);
                UpdateDragConnectionLine(curMouseDownPoint);
            }
